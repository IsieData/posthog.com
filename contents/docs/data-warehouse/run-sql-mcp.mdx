...
| `external-data-sources-preview-resource` | Preview sample rows for one resource of a [Custom REST source](/docs/cdp/sources/custom-rest-source) to verify field mappings before creating the source.                                                                                            |
