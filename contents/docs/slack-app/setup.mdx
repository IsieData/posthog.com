...
A personal GitHub integration is **required** for coding tasks. If you ask a coding question (like "fix the broken checkout flow") without GitHub connected, the bot prompts you to connect first:
...
Non-coding questions work without GitHub. If you ask about product data (like "how do I configure retention?" or "what's our conversion rate?"), the bot answers using the PostHog MCP without repo access.

For coding tasks, this is a hard block – the agent won't plan, edit, or run anything until you've connected GitHub. Each teammate who wants to ship code connects their own account at [**Settings → Personal integrations**](https://app.posthog.com/settings/user-personal-integrations) and clicks **Connect GitHub**. You can connect multiple accounts or organizations – the agent uses them for repo access, commit attribution, and pull request authorship.
