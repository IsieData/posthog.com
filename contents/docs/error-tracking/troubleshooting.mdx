...
> **Tip:** PostHog detects when a significant portion of your JavaScript stack frames are missing source maps and shows a warning banner on the Issues list. Click **Fix with wizard** to run the setup wizard, which automatically configures source map uploads for your framework.
