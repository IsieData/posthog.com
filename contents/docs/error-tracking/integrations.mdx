...
<CalloutBox icon="IconInfo" title="Don't have admin access?" type="fyi">

Connecting integrations requires project admin access. If you don't have admin permissions, visit the integration page and click **Request Access**. Add a short note explaining why your team needs it, and your project admins will receive an email notification with a link to connect it.
