...
- **Manage ingestion rate limits** – Read and update the project-wide and per-issue exception rate limits that cap how many exceptions PostHog ingests.
...
- `Set a project-wide rate limit of 10,000 exceptions per hour.`
