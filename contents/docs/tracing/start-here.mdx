...
- **View span attributes inline** by expanding any span row in the list – click the chevron on the left side of a row to reveal the custom OTel attributes you set, along with intrinsic span details like duration and status
