...
Focus mode hides tiles you don't need, showing only data relevant to your current analysis. Choose from nine analytical concerns, and the dashboard displays the related tiles. Focus mode is personal to you — your teammates see their own views.
