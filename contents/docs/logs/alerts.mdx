...
- **[Microsoft Teams](/docs/cdp/destinations/microsoft-teams)** – paste a URL from a Teams Workflows, Azure Logic Apps, or Power Automate connector. Notifications are delivered as formatted Adaptive Cards.
