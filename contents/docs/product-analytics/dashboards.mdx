...
The Experiments list widget displays a list of your [experiments](/docs/experiments). Each row shows the experiment name, status, creator, and when it was created.
