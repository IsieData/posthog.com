...
Two widgets surface data from [Experiments](/docs/experiments) directly on your dashboards.

The **Experiments list** widget displays your experiments, with each row linking to its detail page. To add it, click the **Add...** dropdown and select **Experiments list** under the **Experiments** group.

**Configuration options:**

- **Status** - Filter experiments by status: draft, running, paused, stopped, or all.
- **Creator** - Optionally filter to experiments created by a specific team member.

The **Experiment results** widget displays the primary metrics and current results for a single experiment, showing up to three metrics with their statistical summaries. To add it, click the **Add...** dropdown and select **Experiment results** under the **Experiments** group.

**Configuration options:**

- **Experiment** - Choose which experiment to display results for.

Clicking the tile title navigates to the experiment detail page.
