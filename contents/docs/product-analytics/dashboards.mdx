...
The Experiments list widget displays a list of your [experiments](/docs/experiments). Each row shows the experiment name, status, conclusion (won, lost, inconclusive, or stopped early), creator, and when it was created.

To add it, click the **Add...** dropdown and select **Experiments list** under the **Experiments** group.

**Configuration options:**

- **Status** - Filter by experiment status: draft, running, paused, stopped, or all. Default: all.
- **Created by** - Filter to show only experiments created by a specific team member.
- **Order by** - Sort experiments by created date, name, or start date.
- **Order direction** - Sort ascending or descending.
- **Limit** - Maximum number of experiments to display. Default: 10, maximum: 25.

Clicking a row opens the experiment. Clicking the tile title navigates to **Experiments**.

#### Experiment results widget

The Experiment results widget displays the current results for a single [experiment](/docs/experiments) without opening it. It shows a scorecard for each of the experiment's primary metrics, up to three.

To add it, click the **Add...** dropdown and select **Experiment results** under the **Experiments** group. The tile shows a "pick an experiment" state until you select one in its settings.

**Configuration options:**

- **Experiment** - The experiment to show results for.
