...
- **Historical trends** – shows how your conversion rate has changed over time for users who entered the funnel on a given date. Useful for understanding how changes, fixes, and new features affect your funnel success rate. You can enable trend lines from the **Options** menu to help identify patterns in noisy data. If recent periods show an unexpected dip, this is often because users who entered recently haven't had enough time to complete the conversion window. Enable **Hide incomplete periods** in the **Options** menu to exclude these periods from the chart.
