...
To skip sentiment computation, open the **Options** menu above the traces table and toggle **Show sentiment** off. When hidden, no sentiment requests are sent – useful for a leaner table view or when you don't need sentiment data.
