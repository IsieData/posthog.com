...
There are two ways scanners produce observations, automatically or on-demand:
...
- **From the scanner overview** – open a scanner, click **Scan session**, and paste a session ID to run the scanner against that specific recording.
