...
| **Device** (beta) | Stable assignment per device. Good fit for anonymous users and experiments that span the pre-login to post-login transition. See [device bucketing](/docs/feature-flags/device-bucketing). |
