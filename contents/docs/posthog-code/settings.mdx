...
Connect GitHub, toggle which data sources feed your [inbox](/docs/self-driving/inbox), and set a priority threshold (P0–P4) that controls when the agent auto-starts tasks assigned to you.
