...
-   Whether to show a back button on multi-question surveys, allowing respondents to return to previous questions.
...
For hosted surveys, you can customize colors, placeholders, and the back button.
