...
3. Generate an API key in Attentive by going to **Marketplace** > **Create app** and creating a private app. Make sure the app has the Webhooks permission enabled. No OAuth is required.
