...
The **Activity** section shows logs for each request your webhook receives. To link directly to this section, add `?section=Activity` to the webhook source URL – useful for sharing debugging links with teammates.
