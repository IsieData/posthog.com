...
Tickets similar to the current one, found using AI-powered similarity search. This panel surfaces related issues from both PostHog Conversations and imported sources like Zendesk. Useful for:

- Finding solutions from similar past issues
- Spotting patterns across your support queue
- Debugging faster by seeing how similar issues were resolved

Related tickets requires [AI data processing](/docs/ai) to be approved for your organization.
