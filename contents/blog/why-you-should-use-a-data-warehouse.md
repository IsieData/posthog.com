...
Once app performance starts to suffer and you're writing enough SQL to fill a book, it’s time to consider offloading that work. You can start small with tools like [DuckDB](/blog/duckdb-vs-clickhouse) for fast, local analytical processing on your own machine, or graduate to a [managed warehouse](/data-stack/warehouse) for team-wide access. 
