...
<TeamMember name="Adlet Smykov" /> has the contacts for these people if you want them.
...
We've sponsored podcasts in the past, took a lil break, and now we're back to sponsoring podcasts again! Here are the ones we did:

- [Lenny's Podcast](https://www.lennyspodcast.com/)
- [Data Engineering podcast](https://www.dataengineeringpodcast.com/)
- [Nerd Snipe](https://www.youtube.com/playlist?list=PLVTctCHLjvuyO2610IQUBqxrBry4eAlYq)
