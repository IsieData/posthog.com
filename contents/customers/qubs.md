...
Using the infrastructure they've developed, Qubs plans to expand beyond Romania and into other service-industry products. And, because of some of the heavier real-time bidding workloads, the team is evaluating PostHog's [Managed Warehouse](/data-stack/warehouse) to help them scale up.
