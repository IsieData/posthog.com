...
export const endpoints = {
    ...
    overview: {
        ...
        description:
            'Use them to build embedded analytics, data feeds, and more – no backend required. Endpoints are how your product’s context flows out to the agents and apps that make it self-driving.',
    ...
    comparison: {
        summary: {
            ...
            us: [
                {
                    title: 'Agents and apps can pull your product’s context through a stable API – the data that powers self-driving',
                },
                {
