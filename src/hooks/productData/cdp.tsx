...
export const cdp = {
    ...
    overview: {
        ...
        description:
            'The CDP is one of the apps that makes your product self-driving: it moves your data wherever agents need to act on it. Import from a warehouse, sync with event data, and send it across 50+ destinations in your stack.',
